...
export PKG_CONFIG_PATH="$(brew --prefix openssl)/lib/pkgconfig:$(brew --prefix libedit)/lib/pkgconfig:$(brew --prefix zlib)/lib/pkgconfig:/usr/X11/lib/pkgconfig:$PKG_CONFIG_PATH"
